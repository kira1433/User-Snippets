//Applying a set of permutations k times O(nlogk)
...
//Permutation Expo
Permutation permute(Permutation sequence, Permutation permutation, long long k) {
    while (k > 0) {
        if (k & 1) {
...
//A group should be invariant under transformation
